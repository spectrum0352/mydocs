...
## Engaging for penetration testing
...
- Requires preapproval by **Environment Owner**
- Standard Rules of Engagement stuff
- Limited to customer owned resources
- No Denial of Service attacks (DoS)
...
### Engagement Initiation and Authorization Flow

1. Penetration Testing Request
2. Define Scope of Azure Tenant
3. Identify Allowed Subscriptions
4. Define In-Scope Resources
5. Obtain Written Authorization
6. Define Rules of Engagement
7. Establish Testing Windows
8. Configure Logging and Monitoring Awareness
9. Prepare Testing Accounts
10. Begin Assessment