...
- **Current User and Domain Name:** whoami (e.g., learn\administrator)

- **User Principal Name (UPN):** whoami /upn (e.g.,
  administrator@learn.com)

- **User in FQDN Format:** whoami /fqdn (e.g.,
  CN=Administrator,CN=Users,DC=learn,DC=com)

- **Logon ID of Current User:** whoami /logonid (e.g., S-1-5-5-0-319776)

- **Security Identifier (SID):** whoami /user (e.g.,
  S-1-5-21-59625805-2643912790-2541880330-500)

- **Groups of Current User:** whoami /groups (Lists all group
  memberships, including built-in and domain groups, along with their
  SIDs and attributes.)

- **Security Privileges of Current User:** whoami /priv (Lists all
  privileges held by the user and their status - enabled or disabled.)
