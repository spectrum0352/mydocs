...
SIEM Solution Features: Log analysis, integration with WAFs, and detection of abnormal web 
...
Examples: 
Script Injection: 
Example: Embedding malicious scripts in user-generated content on a website, which execute in other users' 
